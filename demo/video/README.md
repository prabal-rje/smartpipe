...
80-second smartpipe demo (1920x1080, 30 fps): seven scenes - cold open, the
hook, multimodal, cost honesty, scale, graph, close - all driven by one
reusable `<Terminal>` component and the frame-math constants in
