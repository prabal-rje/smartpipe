...
With no configuration, smartpipe talks to a local [Ollama](https://ollama.com) — the
model runs on your computer, and your text never goes anywhere. smartpipe will **never
